...
\textbf{S3: Cost aware resource management in distributed cloud data centers}

S4: Cost aware management of virtual machines in distributed cloud data centers

S5: Cloud management optimised for real-time electricity pricing
