...
%When extending the estimation window the gaps between estimated and real energy prices generally increase and error measures need to be taken into account to obtain accurate forecasts. 
...
%which has to be taken into account when forecasting energy prices. 
