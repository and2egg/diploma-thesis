...
\thesistitle{Cost aware management of virtual machines in distributed cloud data centers}
\thesissubtitle{} % optional
\thesisdate{18.05.2014}

% all titles and designations have to be gender-related!
\thesisdegree{Diplom-Ingenieur}{Diplom-Ingenieurin}
